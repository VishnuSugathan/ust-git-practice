...
user_pref("LoadRunner.config.user_dir", "D:\\ust-git-practice\\Final Assesment\\LoadRunner Scripts\\FlightBookingTest");
...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1764842284);
...
user_pref("datareporting.healthreport.nextDataSubmissionTime", "1764928563202");
...
user_pref("datareporting.policy.firstRunTime", "1764842163201");
user_pref("datareporting.sessions.current.activeTicks", 21);
user_pref("datareporting.sessions.current.firstPaint", 4657);
user_pref("datareporting.sessions.current.main", 494);
user_pref("datareporting.sessions.current.sessionRestored", 4779);
user_pref("datareporting.sessions.current.startTime", "1764842161612");
...
user_pref("toolkit.startup.last_success", 1764842162);
