...
Action()
{
	...
	lr_start_transaction("SearchFlight1");
	...
	lr_end_transaction("SearchFlight1",0);
	lr_start_transaction("ByTicket1");
	truclient_step("10", "Click on buyFlights button", "snapshot=Action_10.inf");
	lr_end_transaction("ByTicket1",0);
	lr_start_transaction("BookanotherTicket");
	truclient_step("11", "Click on Book Another button", "snapshot=Action_11.inf");
	truclient_step("12", "Click on findFlights button", "snapshot=Action_12.inf");
	truclient_step("13", "Click on reserveFlights button", "snapshot=Action_13.inf");
	truclient_step("14", "Click on buyFlights button", "snapshot=Action_14.inf");
	lr_end_transaction("BookanotherTicket",0);
	lr_start_transaction("ItineraryClear");
	truclient_step("15", "Click on Itinerary Button image", "snapshot=Action_15.inf");
	truclient_step("16", "Click on removeAllFlights button", "snapshot=Action_16.inf");
	truclient_step("17", "Click on Home Button image", "snapshot=Action_17.inf");
	truclient_step("18", "Click on SignOff Button image", "snapshot=Action_18.inf");
	lr_end_transaction("ItineraryClear",0);
