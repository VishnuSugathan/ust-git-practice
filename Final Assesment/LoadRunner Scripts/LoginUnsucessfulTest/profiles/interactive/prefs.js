...
user_pref("LoadRunner.config.user_dir", "D:\\ust-git-practice\\Final Assesment\\LoadRunner Scripts\\LoginUnsucessfulTest");
...
user_pref("datareporting.healthreport.nextDataSubmissionTime", "1764927999869");
...
user_pref("datareporting.policy.firstRunTime", "1764841599869");
user_pref("datareporting.sessions.current.activeTicks", 15);
user_pref("datareporting.sessions.current.firstPaint", 1464);
user_pref("datareporting.sessions.current.main", 68);
user_pref("datareporting.sessions.current.sessionRestored", 1583);
user_pref("datareporting.sessions.current.startTime", "1764841599339");
...
user_pref("toolkit.startup.last_success", 1764841599);
