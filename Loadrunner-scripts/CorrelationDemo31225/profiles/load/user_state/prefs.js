...
user_pref("LoadRunner.config.user_dir", "D:\\ust-git-practice\\Loadrunner-scripts\\CorrelationDemo31225");
...
user_pref("app.update.lastUpdateTime.background-update-timer", 1764762589);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 0);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1764762349);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1764762709);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1764762469);
...
user_pref("browser.slowStartup.averageTime", 1537);
...
user_pref("datareporting.healthreport.nextDataSubmissionTime", "1764848629032");
...
user_pref("datareporting.policy.firstRunTime", "1764762229032");
user_pref("datareporting.sessions.current.activeTicks", 9);
user_pref("datareporting.sessions.current.firstPaint", 1442);
user_pref("datareporting.sessions.current.main", 117);
user_pref("datareporting.sessions.current.sessionRestored", 1559);
user_pref("datareporting.sessions.current.startTime", "1764762228450");
...
user_pref("idle.lastDailyNotification", 1764762713);
...
user_pref("toolkit.startup.last_success", 1764762228);
