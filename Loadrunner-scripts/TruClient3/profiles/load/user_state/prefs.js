...
user_pref("LoadRunner.config.user_dir", "D:\\ust-git-practice\\Loadrunner-scripts\\TruClient3");
...
user_pref("app.update.lastUpdateTime.background-update-timer", 1764585876);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 0);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1764585636);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 0);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1764585756);
...
user_pref("browser.slowStartup.averageTime", 1731);
...
user_pref("datareporting.healthreport.nextDataSubmissionTime", "1764671915709");
...
user_pref("datareporting.policy.firstRunTime", "1764585515708");
user_pref("datareporting.sessions.current.activeTicks", 74);
user_pref("datareporting.sessions.current.firstPaint", 1623);
user_pref("datareporting.sessions.current.main", 61);
user_pref("datareporting.sessions.current.sessionRestored", 1761);
user_pref("datareporting.sessions.current.startTime", "1764585515100");
user_pref("datareporting.sessions.current.totalTime", 397);
...
user_pref("toolkit.startup.last_success", 1764585515);
